...
class Config:
    ...
    MAIL_PORT = 465
    MAIL_USE_SSL = True
    MAIL_USERNAME = os.environ.get('MAIL_USERNAME', '2411519932@qq.com')
    MAIL_PASSWORD = 'qqfmwnyplwmrdhhb'

    FLASKY邮件主题前缀 = '【FLASKY博客】'
    FLASK邮件发送者 = 'FLASK管理员<2411519932@qq.com>'
    FLASKY管理员 = '2411519932@qq.com'
